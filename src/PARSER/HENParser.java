...
public class HENParser extends Parser {
	...
	public static class AssignContext extends ParserRuleContext {
		public List<TerminalNode> ID() { return getTokens(HENParser.ID); }
		public TerminalNode ID(int i) {
			return getToken(HENParser.ID, i);
		}
		public TerminalNode NUMBER() { return getToken(HENParser.NUMBER, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HENListener ) ((HENListener)listener).enterAssign(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof HENListener ) ((HENListener)listener).exitAssign(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof HENVisitor ) return ((HENVisitor<? extends T>)visitor).visitAssign(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class PrintContext extends ParserRuleContext {
		public TerminalNode NUMBER() { return getToken(HENParser.NUMBER, 0); }
		public TerminalNode ID() { return getToken(HENParser.ID, 0); }
